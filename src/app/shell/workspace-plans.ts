...
export const VIEW_PLANS: Readonly<Record<string, ViewPlan>> = {
    'programs.overview': { plannedInputs: ['program', 'target', 'series', 'evidence', 'decision'], plannedReadModels: ['program-overview'], plannedCommands: ['program.list', 'program.get', 'program.create', 'program.update', 'program.objective.record', 'program.hypothesis.record', 'program.decision.record', 'program.milestone.record', 'program.link', 'program.snapshot.create'], emitsSelection: ['program', 'series'], requiredProvenance: ['aggregate version', 'event actor', 'snapshot digest'], dependsOnViews: ['programs.hypotheses', 'programs.progress'], sourceLabel: 'Select program' },
    ...
    'structures.site': { plannedInputs: ['complex', 'protein_structure', 'compound'], plannedReadModels: ['binding-site-opportunity'], plannedCommands: ['structure.field.compute', 'structure.surface.compute'], emitsSelection: ['complex', 'field'], requiredProvenance: ['structure quality', 'field method version', 'artifact digest'], dependsOnViews: ['structures.complex'], sourceLabel: 'Select complex' },
