...
export const RendererParams = {
    ...
    subsurfaceStrength: PD.Numeric(0, { min: 0.0, max: 1.0, step: 0.01 }, { description: 'Diffuse wrap used as a low-cost subsurface-scattering approximation.' }),
...
namespace Renderer {
    ...
    export function create(ctx: WebGLContext, props: Partial<RendererProps> = {}): Renderer {
        ...
        const globalUniforms: GlobalUniformValues = {
            ...
            uSubsurfaceStrength: ValueCell.create(p.subsurfaceStrength),
        ...
        return {
            ...
            setProps: (props: Partial<RendererProps>) => {
                ...
                if (props.subsurfaceStrength !== undefined && props.subsurfaceStrength !== p.subsurfaceStrength) {
                    p.subsurfaceStrength = props.subsurfaceStrength;
                    ValueCell.update(globalUniforms.uSubsurfaceStrength, p.subsurfaceStrength);
                }
