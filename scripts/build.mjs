...
const Apps = [
    ...
    { kind: 'app', name: 'dirac', filename: 'dirac.js', entryRoot: './src/app.frontend.facets.molstar-rdkit.editable', staticDirs: ['assets/rdkit'], staticFiles: ['theme-fascia.css','theme-fascia.js','workspace-shell.css','addons.css','palette.js'] },
